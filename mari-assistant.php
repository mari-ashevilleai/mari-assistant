 ...
 * Plugin URI: https://github.com/yourusername/mari-assistant
 ...
 * License: GPL2
 * GitHub Plugin URI: https://github.com/yourusername/mari-assistant
 * GitHub Branch: main
 */
...
function mari_enqueue_scripts() {
    wp_enqueue_script('mari-popup', plugin_dir_url(__FILE__) . 'js/mari-popup.js', array('jquery'), '1.2.0', true);
