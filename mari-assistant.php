 ...
 * Description: Elite AI Assistant with working chat UI, memory logging, Enter-to-send, and OpenAI integration.
 * Version: 1.2.7
...
function mari_enqueue_scripts() {
    wp_enqueue_script('mari-popup', plugin_dir_url(__FILE__) . 'js/mari-popup.js', array('jquery'), '1.2.7', true);
